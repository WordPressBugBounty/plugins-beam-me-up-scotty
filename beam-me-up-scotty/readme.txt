...
#### 1.0.19
* New: Added a setting to set the bottom indentation of the back to top button
* New: Added a "custom" option to the button size setting
* New: Added a width and height setting to set the size of the button when using the custom size option
